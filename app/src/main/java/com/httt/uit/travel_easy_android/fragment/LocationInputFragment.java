...
public class LocationInputFragment extends Fragment {
    ...
    public static LocationInputFragment newInstance(String title, int resMainImage, int resSecondaryImage) {
...
//        title = getArguments().getString("title");
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_airport_input,container,false);
        return view;
    }
}
